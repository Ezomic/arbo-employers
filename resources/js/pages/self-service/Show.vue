    ...
    <div class="flex flex-col gap-6 p-4">
        ...
        <div class="flex justify-end">
            <Button variant="outline" size="sm" as-child>
                <a :href="gdprExport().url" download>
                    <Download class="size-3.5" />
                    Download uw gegevens (AVG Art. 15)
                </a>
            </Button>
        </div>
        ...
        <div class="rounded-lg border p-4 text-sm text-muted-foreground">
            ...
            <p class="mt-1">
                U heeft recht op inzage in uw persoonsgegevens (AVG Art. 15) en
                het recht op dataportabiliteit (AVG Art. 20). Medische gegevens
                worden beheerd door uw bedrijfsarts en zijn niet opgenomen in
                dit overzicht (WGBO Art. 456). Neem contact op met uw
                arbo-dienst voor vragen over uw dossier.
            </p>
        </div>
    </div>
</template>
