...
* @route '/self-service/gdpr-export'
*/
const gdprExportForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/self-service/gdpr-export'
*/
gdprExportForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: gdprExport.url(options),
    method: 'get',
})
...
* @route '/self-service/gdpr-export'
*/
gdprExportForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
